...
const StatusMap: React.FC<StatusCardProps> = ({ status, loading }) => {
  if (loading) {
    return (
    ...
    return (
      <div className="bg-blue-950/30 rounded-lg shadow-lg p-6 border border-white/20">
        ...
        <p className="text-blue-200/80">
          No se pudo cargar el estado de los vuelos
        </p>
      </div>
    );
  }
    ...
    <div className="bg-gradient-to-r from-blue-950/30 to-blue-900/30 rounded-lg shadow-lg p-6 border border-white/20">
      ...
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-blue-200 font-medium">Vuelos Activos</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-blue-200 font-medium">Vuelos en Tierra</span>
          <div className="flex items-center gap-2">
        ...
        <div className="flex items-center justify-between">
          <span className="text-blue-200 font-medium">Vuelos con Alertas</span>
          <div className="flex items-center gap-2">
        ...
        <div className="pt-4 border-t border-blue-800/40">
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-sm text-blue-200/80">Total Vuelos</p>
              <p className="text-2xl font-bold text-blue-200">
  {status?.total_records?.toLocaleString?.() ?? "N/A"}
</p>
